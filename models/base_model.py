...
class BaseModel():
    ...
    def save_network(self,
                     ...
                     score=0,
                     identifier='psnr'):
        save_filename = '{}_{}_{}_{}.pth'.format(iter_step, network_label,
    ...
    def save_training_state(self, epoch, iter_step, identifier='psnr'):
        ...
        save_filename = '{}_{}.state'.format(iter_step, identifier)
